...
import 'package:mobile_1/pages/widget/content_model.dart';
      ...
      body:Column(children: [
              ...
              itemBuilder: (_, i){
                return Padding(
                  ...
                  child: Column(children: [
                    Image.asset(contents[i].image, height: 300, width: MediaQuery.of(context).size.width*0.8,fit: BoxFit.fill ),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child:Center(
              child: Text(currentIndex==contents.length-1? "Start": "Next", style: TextStyle(color: Colors.white,fontSize:20.0,fontWeight: FontWeight.bold ),
              ),
            ),
